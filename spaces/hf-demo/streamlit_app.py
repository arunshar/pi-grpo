...
with tab_trends:
    ...
    if not trajectories:
        ...
        st.dataframe(traj_df, hide_index=True, width="stretch", height=360)
        ...
        st.dataframe(class_summary, hide_index=True, width="stretch")
        ...
        if preferences:
            ...
            st.dataframe(pref_df, hide_index=True, width="stretch", height=300)
            st.caption(
