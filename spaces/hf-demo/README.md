...
pinned: true
license: mit
short_description: Physics-informed PPO, DPO, and GRPO trajectory reward demo
---

# Pi-GRPO — Hugging Face Space

A standalone Streamlit demo of [Pi-GRPO](https://github.com/arunshar/pi-grpo), the physics-informed RL stack (PPO, DPO, GRPO with a hybrid physics-aware reward) described in the [NeurIPS-style preprint](https://github.com/arunshar/pi-grpo/blob/main/paper/pi_grpo_neurips.pdf).
